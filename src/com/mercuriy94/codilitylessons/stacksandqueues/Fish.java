...
/**
 * You are given two non-empty arrays A and B consisting of N integers. Arrays A and B represent N voracious fish i
    ...
    public static int solution(int[] A, int[] B) {
        ...
        for (int i = 0; i < N; i++) {
            ...
            if (downstream.isEmpty()) {
                ...
                boolean isWasEaten = false;

                while (!isWasEaten && !downstream.isEmpty()) {
                    int downFish = downstream.peek();
